            ...
            <tbody>
              ...
              <tr> 
                ...
                <td>
                  ...
                  <input type="text" class="inputTxt p100" name="warehouse_nm" id="warehouse_nm" v-model="warehouse_nm" placeholder="창고명"  :readonly="readonly"/>
                </td>
  ...
  methods: {
    ...
    save: function () {
      ...
      console.log("file2::",this.file);
        ...
        params.append("file_ofname", this.file_ofname);
        params.append("file_size", this.file_size);
